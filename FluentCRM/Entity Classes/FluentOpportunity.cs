...
{
    /// <summary>
    /// FluentCRM class used to encapsulate access to the Opportunity Entity
    /// </summary>
    public class FluentOpportunity : FluentCRM
    {
        ...
        public static IEntitySet Opportunity(Guid id, IOrganizationService service)
        {
            return new FluentOpportunity(id, service);
        }
        /// <summary>
        ...
        public static IUnknownEntity Opportunity(IOrganizationService service)
        {
            return new FluentOpportunity(service);
        }
        /// <summary>
