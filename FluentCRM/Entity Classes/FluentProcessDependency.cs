...
{
    /// <summary>
    /// FluentCRM class used to encapsulate access to the ProcessDependency Entity
    /// </summary>
    public class FluentProcessDependency : FluentCRM
    {

        private const string _logicalName = "workflowdependency";

        #region "Constructors etc required by Language"
        private FluentProcessDependency(Guid id, IOrganizationService service) : base(_logicalName, id, service) { }

        /// <summary>
        /// Set IOrganizationService to use
        /// </summary>
        /// <param name="service"></param>
        protected FluentProcessDependency(IOrganizationService service) : base(_logicalName, service) { }

        private FluentProcessDependency(Guid id) : base(_logicalName, id) { }
        ...
        public static IEntitySet ProcessDependency(Guid id, IOrganizationService service)
        {
            return new FluentProcessDependency(id, service);
        }
        ...
        public static IUnknownEntity ProcessDependency(IOrganizationService service)
        {
            return new FluentProcessDependency(service);
        }
        ...
        /// <returns>FluentCRM subclass - returns even if ID does not exist.</returns>
        public static IEntitySet ProcessDependency(Guid id)
        {
            return new FluentProcessDependency(id);
        }
        ...
        /// </summary>
        /// <returns>FluentCRM subclass that can be used to filter and operate on the specified entity type.</returns>
        public static IUnknownEntity ProcessDependency()
        {
            return new FluentProcessDependency();
        }

        /// <summary>
        /// Parameterless constructor required by the language, but not necessarily used.
        /// </summary>
        public FluentProcessDependency() : base(_logicalName) { }
