...
namespace FluentCRM
{
    ...
    public class FluentTeam : FluentCRM, ITeamSet
    {
        ...
        private FluentTeam(Guid id, IOrganizationService service) : base(_logicalName, id, service) { }

        private FluentTeam(IOrganizationService service) : base(_logicalName, service) { }

        private FluentTeam(Guid id) : base(_logicalName, id) { }
        ...
        public static IUnknownEntity Team(IOrganizationService service)
        {
            return new FluentTeam(service);
        }
        ...
        /// </summary>
        /// <returns>FluentCRM subclass that can be used to filter and operate on the specified entity type.</returns>
        public static IUnknownEntity Team()
        {
            return new FluentTeam();
        }

        /// <summary>
        /// Parameterless constructor required by the language, but not necessarily used.
        /// </summary>
        public FluentTeam() : base(_logicalName) { }
