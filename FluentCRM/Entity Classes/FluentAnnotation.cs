...
{
    /// <summary>
    /// FluentCRM class used to encapsulate access to the Annotation Entity
    /// </summary>
    public class FluentAnnotation : FluentCRM
    {

        private const string _logicalName = "annotation";
        ...
        protected FluentAnnotation(IOrganizationService service) : base(_logicalName, service) { }
