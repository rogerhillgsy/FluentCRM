...
{
    /// <summary>
    /// FluentCRM class used to encapsulate access to the Lead Entity
    /// </summary>
    public class FluentLead : FluentCRM
    {

        private const string _logicalName = "lead";

        #region "Constructors etc required by Language"
        private FluentLead(Guid id, IOrganizationService service) : base(_logicalName, id, service) { }

        protected FluentLead(IOrganizationService service) : base(_logicalName, service) { }

        private FluentLead(Guid id) : base(_logicalName, id) { }
        ...
        public static IEntitySet Lead(Guid id, IOrganizationService service)
        {
            return new FluentLead(id, service);
        }
        ...
        public static IUnknownEntity Lead(IOrganizationService service)
        {
            return new FluentLead(service);
        }
        ...
        /// <returns>FluentCRM subclass - returns even if ID does not exist.</returns>
        public static IEntitySet Lead(Guid id)
        {
            return new FluentLead(id);
        }
        ...
        /// </summary>
        /// <returns>FluentCRM subclass that can be used to filter and operate on the specified entity type.</returns>
        public static IUnknownEntity Lead()
        {
            return new FluentLead();
        }

        /// <summary>
        /// Parameterless constructor required by the language, but not necessarily used.
        /// </summary>
        public FluentLead() : base(_logicalName) { }
