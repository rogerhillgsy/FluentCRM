...
{
    /// <summary>
    /// FluentCRM class used to encapsulate access to the PluginTraceLog Entity
    /// </summary>
    public class FluentPluginTraceLog : FluentCRM
    {

        private const string _logicalName = "plugintracelog";
        #region "Constructors etc required by Language"
        private FluentPluginTraceLog(Guid id, IOrganizationService service) : base(_logicalName, id, service) { }
        private FluentPluginTraceLog(IOrganizationService service) : base(_logicalName, service) { }
        private FluentPluginTraceLog(Guid id) : base(_logicalName, id) { }
        /// <summary>
        ...
        public static IEntitySet PluginTraceLog(Guid id, IOrganizationService service)
        {
            return new FluentPluginTraceLog(id, service);
        }
        /// <summary>
        ...
        public static IUnknownEntity PluginTraceLog(IOrganizationService service)
        {
            return new FluentPluginTraceLog(service);
        }
        /// <summary>
        ...
        /// <returns>FluentCRM subclass - returns even if ID does not exist.</returns>
        public static IEntitySet PluginTraceLog(Guid id)
        {
            return new FluentPluginTraceLog(id);
        }
        /// <summary>
        /// Select a (sub)set of the specified entity using the static organization service specified by FluentCRM.StaticService
        /// </summary>
        /// <returns>FluentCRM subclass that can be used to filter and operate on the specified entity type.</returns>
        public static IUnknownEntity PluginTraceLog()
        {
            return new FluentPluginTraceLog();
        }
        /// <summary>
        /// Parameterless constructor required by the language, but not necessarily used.
        /// </summary>
        public FluentPluginTraceLog() : base(_logicalName) { }
        /// <summary>
