...
{
    /// <summary>
    /// FluentCRM class used to encapsulate access to the l Entity
    /// </summary>
    public class FluentPluginType : FluentCRM
    {
        ...
        public static IEntitySet l(Guid id, IOrganizationService service)
        {
        ...
        public static IUnknownEntity l(IOrganizationService service)
        {
        ...
        /// <returns>FluentCRM subclass - returns even if ID does not exist.</returns>
        public static IEntitySet l(Guid id)
        {
        ...
        /// </summary>
        /// <returns>FluentCRM subclass that can be used to filter and operate on the specified entity type.</returns>
        public static IUnknownEntity l()
        {
